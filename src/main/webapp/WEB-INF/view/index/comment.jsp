...
<body>
	...
	<form name="example" method="post" action="demo.jsp">
		<textarea name="content" cols="100" rows="8" style="width:1030px;height:200px;visibility:hidden;"><%=htmlspecialchars(htmlData)%></textarea>
		<br />
		<input type="button" name="button" value="提交内容"  onclick="addComment()"/>
	</form>
	<a href="my/article/addShow"><button class="btn btn-success">加入收藏夹</button></a>
</body>
